...
.kids-link{{display:inline-flex;align-items:center;gap:7px;margin-top:16px;background:var(--gold);color:#fff;font-size:13px;font-weight:700;padding:9px 18px;border-radius:22px;text-decoration:none;position:relative;z-index:1;box-shadow:0 2px 8px rgba(184,149,42,.35);}}
.kids-link:active{{filter:brightness(.94);}}
/* 필터 탭 */
...
<header class="hdr">
  <div class="hdr-inner">
    ...
    <a class="kids-link" href="kids/">🧒 주일학교(초등부) 설교노트 보기 →</a>
  </div>
</header>
<!-- 필터 탭 -->
